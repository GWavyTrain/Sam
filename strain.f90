PROGRAM GWstrainFromBHBmergers
  ...
  INTEGER  , PARAMETER   :: iID = 1 , iz = 3 , iM1 = 7 , iM2 = 8
  ...
  WRITE( 101 , '(I17,1x,F7.4,1x,F7.4,1x,F13.10,1x,E16.10,900E13.6)' ) &
  ...
  DO Nz = 26 , 27!135
    ...
    IF ( ( Nz .NE. 53 ) .AND. ( Nz .NE. 55 ) ) THEN
      ...
      DO i = 1 , nLinesIllustris
        ...
        WRITE( 101 , '(I17,1x,F7.4,1x,F7.4,1x,F13.10,1x,E16.10,1x)' , &
