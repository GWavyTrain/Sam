PROGRAM GWstrainFromBHBmergers
  ...
  REAL(DP) , PARAMETER   :: tau = 4.0d0 * 86400.0d0 * 365.25d0
  ...
  INTEGER( KIND = 8 )    :: nLinesIllustris, MergerID, Nss, SS(2), i, j, k
  INTEGER                :: iArg
  ...
  WRITE( 100, &
  '(I7,1x,F7.4,1x,F7.4,1x,F13.10,1x,ES16.10,1x,ES16.10,1x,ES16.10,10ES13.6)' ) &
  ...
  DO Nss = SS(1), SS(2)
    ...
    IF ( ( Nss .NE. 53 ) .AND. ( Nss .NE. 55 ) ) THEN
      ...
      DO i = 1, nLinesIllustris
        ...
        MergerID = INT( IllustrisData(i,iID), 4 )
        ...
        OPEN ( 100, FILE = 'hc.dat', POSITION = 'APPEND' )
        WRITE( 100, &
            '(I7,1x,F7.4,1x,F7.4,1x,F13.10,1x,ES16.10,1x,ES16.10,1x,ES16.10)', &
               ADVANCE = 'NO' ) MergerID, M1, M2, tLB, z, f_ISCO, r / 3.086d24
